...
::: {style="font-size: 0.55em; line-height: 1.5;"}

Abidin, H. Z., Andreas, H., Gumilar, I., & Wibowo, I. R. R. (2015). On correlation between urban development, land subsidence and flooding phenomena in Jakarta. *Proceedings of the IAHS*, 370, 15–20. https://doi.org/10.5194/piahs-370-15-2015  

Abidin, H. Z., Andreas, H., Gumilar, I., Fukuda, Y., Pohan, Y. E., & Deguchi, T. (2011). Land subsidence of Jakarta and its relation with urban development. *Natural Hazards*, 59, 1753–1771.  

Badan Pusat Statistik (BPS). (2023). *Jakarta in Figures 2023*.  

Jakarta Satu. (n.d.). Jakarta Satu Geoportal. https://jakartasatu.jakarta.go.id/  

Schumann, G. J.-P., & Di Baldassarre, G. (2010). The direct use of radar satellites for flood risk mapping. *Hydrological Processes*.  

Tellman, B., et al. (2021). Satellite imaging reveals increased population exposure to floods. *Nature*.  

Twele, A., et al. (2016). Sentinel-1-based flood mapping: automated processing chain. *Remote Sensing*.  
